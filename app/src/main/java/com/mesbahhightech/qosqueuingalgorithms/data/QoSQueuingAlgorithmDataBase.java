...
public abstract class QoSQueuingAlgorithmDataBase extends RoomDatabase {
    ...
    public static synchronized QoSQueuingAlgorithmDataBase getInstance(Context context){
        if (instance == null) {
            instance = Room.databaseBuilder(context.getApplicationContext(),
                    QoSQueuingAlgorithmDataBase.class, "qosqueuingalgorithmdatabase2")
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            queueDao.insert(new Queue("Time", "0.5;1;1.5;2;2.5;3;3.5;4;4.5;5;5.5;6;6.5;7;7.5;8;8.5;9;9.5;10",2));
            queueDao.insert(new Queue("File A", " ;A; ; ;A; ; ; ;A;A; ; ;A; ; ; ; ; ; ; ",2));
            queueDao.insert(new Queue("File B", " ;B; ;B; ; ;B; ;B; ; ;B;B; ; ; ; ; ; ; ",2));
            queueDao.insert(new Queue("File C", " ;C; ;C;C;C;C; ; ;C; ;C; ;C; ; ; ; ; ; ",2));

            exampleDao.insert(new Example("Exmple 03: SPQ, RR, WRR",4,20));
            queueDao.insert(new Queue("Time", "0.5;1;1.5;2;2.5;3;3.5;4;4.5;5;5.5;6;6.5;7;7.5;8;8.5;9;9.5;10",3));
            queueDao.insert(new Queue("File A", " ; ; ;A; ; ; ;A; ; ; ;A; ; ; ;A; ; ; ;A",3));
            queueDao.insert(new Queue("File B", " ;B; ;B; ;B; ;B; ;B; ;B; ;B; ;B; ;B; ;B",3));
            queueDao.insert(new Queue("File C", "C;C;C;C;C;C;C;C;C;C;C;C;C;C;C;C;C;C;C;C",3));

            exampleDao.insert(new Example("Exmple 04: WRR-T,DWRR-T",3,20));
            queueDao.insert(new Queue("Time", "0.5;1;1.5;2;2.5;3;3.5;4;4.5;5;5.5;6;6.5;7;7.5;8;8.5;9;9.5;10",4));
            queueDao.insert(new Queue("File A", " ;500; ; ; ;700; ;800; ; ; ;300; ;400; ; ; ; ; ; ",4));
            queueDao.insert(new Queue("File B", " ;750; ;1000; ; ; ;950; ;650; ;550; ; ; ; ; ; ; ; ",4));
            queueDao.insert(new Queue("File C", " ;550; ;450; ;750; ; ; ;350; ; ; ;550; ; ; ; ; ; ",4));

            exampleDao.insert(new Example("Exmple 05: WRR-T,DWRR-T",3,20));
            queueDao.insert(new Queue("Time", "0.5;1;1.5;2;2.5;3;3.5;4;4.5;5;5.5;6;6.5;7;7.5;8;8.5;9;9.5;10",5));
            queueDao.insert(new Queue("File A", " ;1000; ;600;500; ;600;400;;500; ; ; ; ; ; ; ; ; ; ",5));
            queueDao.insert(new Queue("File B", " ;400; ;300; ;400;300;600; ;500; ; ; ; ; ; ; ; ; ; ",5));
            queueDao.insert(new Queue("File C", " ;300; ;200;400; ; ;500;400; ;300; ; ; ; ; ; ; ; ; ",5));
